...
#define AS_EQ_U64(exp1, exp2)             _ASX_2(uint64_t,exp1,==,exp2,"%lu","") // Assert exp1 == exp2 (uint64_t)
#define AS_NE_U64(exp1, exp2)             _ASX_2(uint64_t,exp1,!=,exp2,"%lu","") // Assert exp1 != exp2 (uint64_t)
#define AS_LT_U64(exp1, exp2)             _ASX_2(uint64_t,exp1,< ,exp2,"%lu","") // Assert exp1 < exp2 (uint64_t)
#define AS_LE_U64(exp1, exp2)             _ASX_2(uint64_t,exp1,<=,exp2,"%lu","") // Assert exp1 <= exp2 (uint64_t)
#define AS_GT_U64(exp1, exp2)             _ASX_2(uint64_t,exp1,> ,exp2,"%lu","") // Assert exp1 > exp2 (uint64_t)
#define AS_GE_U64(exp1, exp2)             _ASX_2(uint64_t,exp1,>=,exp2,"%lu","") // Assert exp1 >= exp2 (uint64_t)

...
#define AS_BETWEEN_EI_INT(low, exp, high) __ASSERTX_TWO_OP__(low,< ,exp,<=,high,"%d","") // Assert low < exp <= high (int)
#define AS_BETWEEN_EE_INT(low, exp, high) __ASSERTX_TWO_OP__(low,< ,exp,< ,high,"%d","") // Assert low < exp < high (int)
...
#define AS_BETWEEN_EI_I8(low, exp, high) __ASSERTX_TWO_OP__(low,< ,exp,<=,high,"%hhd","") // Assert low < exp <= high (int8_t)
#define AS_BETWEEN_EE_I8(low, exp, high) __ASSERTX_TWO_OP__(low,< ,exp,< ,high,"%hhd","") // Assert low < exp < high (int8_t)
...
#define AS_BETWEEN_EI_I16(low, exp, high) __ASSERTX_TWO_OP__(low,< ,exp,<=,high,"%hd","") // Assert low < exp <= high (int16_t)
#define AS_BETWEEN_EE_I16(low, exp, high) __ASSERTX_TWO_OP__(low,< ,exp,< ,high,"%hd","") // Assert low < exp < high (int16_t)
...
#define AS_BETWEEN_EI_I32(low, exp, high) __ASSERTX_TWO_OP__(low,< ,exp,<=,high,"%d","") // Assert low < exp <= high (int32_t)
#define AS_BETWEEN_EE_I32(low, exp, high) __ASSERTX_TWO_OP__(low,< ,exp,< ,high,"%d","") // Assert low < exp < high (int32_t)
...
#define AS_BETWEEN_EI_I64(low, exp, high) __ASSERTX_TWO_OP__(low,< ,exp,<=,high,"%lld","") // Assert low < exp <= high (int64_t)
#define AS_BETWEEN_EE_I64(low, exp, high) __ASSERTX_TWO_OP__(low,< ,exp,< ,high,"%lld","") // Assert low < exp < high (int64_t)
...
#define AS_BETWEEN_EI_U8(low, exp, high) __ASSERTX_TWO_OP__(low,< ,exp,<=,high,"%hhu","") // Assert low < exp <= high (uint8_t)
#define AS_BETWEEN_EE_U8(low, exp, high) __ASSERTX_TWO_OP__(low,< ,exp,< ,high,"%hhu","") // Assert low < exp < high (uint8_t)
...
#define AS_BETWEEN_EI_U16(low, exp, high) __ASSERTX_TWO_OP__(low,< ,exp,<=,high,"%hu","") // Assert low < exp <= high (uint16_t)
#define AS_BETWEEN_EE_U16(low, exp, high) __ASSERTX_TWO_OP__(low,< ,exp,< ,high,"%hu","") // Assert low < exp < high (uint16_t)
...
#define AS_BETWEEN_EI_U32(low, exp, high) __ASSERTX_TWO_OP__(low,< ,exp,<=,high,"%u","") // Assert low < exp <= high (uint32_t)
#define AS_BETWEEN_EE_U32(low, exp, high) __ASSERTX_TWO_OP__(low,< ,exp,< ,high,"%u","") // Assert low < exp < high (uint32_t)
...
#define AS_BETWEEN_EI_U64(low, exp, high) __ASSERTX_TWO_OP__(low,< ,exp,<=,high,"%llu","") // Assert low < exp <= high (uint64_t)
#define AS_BETWEEN_EE_U64(low, exp, high) __ASSERTX_TWO_OP__(low,< ,exp,< ,high,"%llu","") // Assert low < exp < high (uint64_t)
...
#define AS_BETWEEN_EI_PTR(low, exp, high) __ASSERTX_TWO_OP__(low,< ,exp,<=,high,"%p","") // Assert low < exp <= high (void *)
#define AS_BETWEEN_EE_PTR(low, exp, high) __ASSERTX_TWO_OP__(low,< ,exp,< ,high,"%p","") // Assert low < exp < high (void *)
#define AS_EQ_CHAR(exp1, exp2)             __ASSERTX_ONE_OP__(exp1,==,exp2,"%c","") // Assert exp1 == exp2 (char)
#define AS_NE_CHAR(exp1, exp2)             __ASSERTX_ONE_OP__(exp1,!=,exp2,"%c","") // Assert exp1 != exp2 (char)
#define AS_LT_CHAR(exp1, exp2)             __ASSERTX_ONE_OP__(exp1,< ,exp2,"%c","") // Assert exp1 < exp2 (char)
#define AS_LE_CHAR(exp1, exp2)             __ASSERTX_ONE_OP__(exp1,<=,exp2,"%c","") // Assert exp1 <= exp2 (char)
#define AS_GT_CHAR(exp1, exp2)             __ASSERTX_ONE_OP__(exp1,> ,exp2,"%c","") // Assert exp1 > exp2 (char)
#define AS_GE_CHAR(exp1, exp2)             __ASSERTX_ONE_OP__(exp1,>=,exp2,"%c","") // Assert exp1 >= exp2 (char)
#define AS_BETWEEN_IE_CHAR(low, exp, high) __ASSERTX_TWO_OP__(low,<=,exp,< ,high,"%c","") // Assert low <= exp < high (char)
#define AS_BETWEEN_II_CHAR(low, exp, high) __ASSERTX_TWO_OP__(low,<=,exp,<=,high,"%c","") // Assert low <= exp <= high (char)
#define AS_BETWEEN_EI_CHAR(low, exp, high) __ASSERTX_TWO_OP__(low,< ,exp,<=,high,"%c","") // Assert low < exp <= high (char)
#define AS_BETWEEN_EE_CHAR(low, exp, high) __ASSERTX_TWO_OP__(low,< ,exp,< ,high,"%c","") // Assert low < exp < high (char)
...
#define AS_BETWEEN_EI_SIZET(low, exp, high) __ASSERTX_TWO_OP__(low,< ,exp,<=,high,"%zu","") // Assert low < exp <= high (size_t)
#define AS_BETWEEN_EE_SIZET(low, exp, high) __ASSERTX_TWO_OP__(low,< ,exp,< ,high,"%zu","") // Assert low < exp < high (size_t)
...
#define AS_BETWEEN_EI_SSIZET(low, exp, high) __ASSERTX_TWO_OP__(low,< ,exp,<=,high,"%zd","") // Assert low < exp <= high (ssize_t)
#define AS_BETWEEN_EE_SSIZET(low, exp, high) __ASSERTX_TWO_OP__(low,< ,exp,< ,high,"%zd","") // Assert low < exp < high (ssize_t)
...
#define AS_BETWEEN_EI_F32(low, exp, high) __ASSERTX_TWO_OP__(low,< ,exp,<=,high,"%f","") // Assert low < exp <= high (float)
#define AS_BETWEEN_EE_F32(low, exp, high) __ASSERTX_TWO_OP__(low,< ,exp,< ,high,"%f","") // Assert low < exp < high (float)
...
#define AS_BETWEEN_EI_F64(low, exp, high) __ASSERTX_TWO_OP__(low,< ,exp,<=,high,"%f","") // Assert low < exp <= high (double)
#define AS_BETWEEN_EE_F64(low, exp, high) __ASSERTX_TWO_OP__(low,< ,exp,< ,high,"%f","") // Assert low < exp < high (double)
...
#define ASX_BETWEEN_EI_INT(low, exp, high, fmt, ...) __ASSERTX_TWO_OP__(low,< ,exp,<=,high,"%d",fmt,##__VA_ARGS__) // Assert low < exp <= high (int)
#define ASX_BETWEEN_EE_INT(low, exp, high, fmt, ...) __ASSERTX_TWO_OP__(low,< ,exp,< ,high,"%d",fmt,##__VA_ARGS__) // Assert low < exp < high (int)
...
#define ASX_BETWEEN_EI_I8(low, exp, high, fmt, ...) __ASSERTX_TWO_OP__(low,< ,exp,<=,high,"%hhd",fmt,##__VA_ARGS__) // Assert low < exp <= high (int8_t)
#define ASX_BETWEEN_EE_I8(low, exp, high, fmt, ...) __ASSERTX_TWO_OP__(low,< ,exp,< ,high,"%hhd",fmt,##__VA_ARGS__) // Assert low < exp < high (int8_t)
...
#define ASX_BETWEEN_EI_I16(low, exp, high, fmt, ...) __ASSERTX_TWO_OP__(low,< ,exp,<=,high,"%hd",fmt,##__VA_ARGS__) // Assert low < exp <= high (int16_t)
#define ASX_BETWEEN_EE_I16(low, exp, high, fmt, ...) __ASSERTX_TWO_OP__(low,< ,exp,< ,high,"%hd",fmt,##__VA_ARGS__) // Assert low < exp < high (int16_t)
...
#define ASX_BETWEEN_EI_I32(low, exp, high, fmt, ...) __ASSERTX_TWO_OP__(low,< ,exp,<=,high,"%d",fmt,##__VA_ARGS__) // Assert low < exp <= high (int32_t)
#define ASX_BETWEEN_EE_I32(low, exp, high, fmt, ...) __ASSERTX_TWO_OP__(low,< ,exp,< ,high,"%d",fmt,##__VA_ARGS__) // Assert low < exp < high (int32_t)
...
#define ASX_BETWEEN_EI_I64(low, exp, high, fmt, ...) __ASSERTX_TWO_OP__(low,< ,exp,<=,high,"%lld",fmt,##__VA_ARGS__) // Assert low < exp <= high (int64_t)
#define ASX_BETWEEN_EE_I64(low, exp, high, fmt, ...) __ASSERTX_TWO_OP__(low,< ,exp,< ,high,"%lld",fmt,##__VA_ARGS__) // Assert low < exp < high (int64_t)
...
#define ASX_BETWEEN_EI_U8(low, exp, high, fmt, ...) __ASSERTX_TWO_OP__(low,< ,exp,<=,high,"%hhu",fmt,##__VA_ARGS__) // Assert low < exp <= high (uint8_t)
#define ASX_BETWEEN_EE_U8(low, exp, high, fmt, ...) __ASSERTX_TWO_OP__(low,< ,exp,< ,high,"%hhu",fmt,##__VA_ARGS__) // Assert low < exp < high (uint8_t)
...
#define ASX_BETWEEN_EI_U16(low, exp, high, fmt, ...) __ASSERTX_TWO_OP__(low,< ,exp,<=,high,"%hu",fmt,##__VA_ARGS__) // Assert low < exp <= high (uint16_t)
#define ASX_BETWEEN_EE_U16(low, exp, high, fmt, ...) __ASSERTX_TWO_OP__(low,< ,exp,< ,high,"%hu",fmt,##__VA_ARGS__) // Assert low < exp < high (uint16_t)
...
#define ASX_BETWEEN_EI_U32(low, exp, high, fmt, ...) __ASSERTX_TWO_OP__(low,< ,exp,<=,high,"%u",fmt,##__VA_ARGS__) // Assert low < exp <= high (uint32_t)
#define ASX_BETWEEN_EE_U32(low, exp, high, fmt, ...) __ASSERTX_TWO_OP__(low,< ,exp,< ,high,"%u",fmt,##__VA_ARGS__) // Assert low < exp < high (uint32_t)
...
#define ASX_BETWEEN_EI_U64(low, exp, high, fmt, ...) __ASSERTX_TWO_OP__(low,< ,exp,<=,high,"%llu",fmt,##__VA_ARGS__) // Assert low < exp <= high (uint64_t)
#define ASX_BETWEEN_EE_U64(low, exp, high, fmt, ...) __ASSERTX_TWO_OP__(low,< ,exp,< ,high,"%llu",fmt,##__VA_ARGS__) // Assert low < exp < high (uint64_t)
...
#define ASX_BETWEEN_EI_PTR(low, exp, high, fmt, ...) __ASSERTX_TWO_OP__(low,< ,exp,<=,high,"%p",fmt,##__VA_ARGS__) // Assert low < exp <= high (void *)
#define ASX_BETWEEN_EE_PTR(low, exp, high, fmt, ...) __ASSERTX_TWO_OP__(low,< ,exp,< ,high,"%p",fmt,##__VA_ARGS__) // Assert low < exp < high (void *)
...
#define ASX_BETWEEN_EI_CHAR(low, exp, high, fmt, ...) __ASSERTX_TWO_OP__(low,< ,exp,<=,high,"%c",fmt,##__VA_ARGS__) // Assert low < exp <= high (char)
#define ASX_BETWEEN_EE_CHAR(low, exp, high, fmt, ...) __ASSERTX_TWO_OP__(low,< ,exp,< ,high,"%c",fmt,##__VA_ARGS__) // Assert low < exp < high (char)
...
#define ASX_BETWEEN_EI_SIZET(low, exp, high, fmt, ...) __ASSERTX_TWO_OP__(low,< ,exp,<=,high,"%zu",fmt,##__VA_ARGS__) // Assert low < exp <= high (size_t)
#define ASX_BETWEEN_EE_SIZET(low, exp, high, fmt, ...) __ASSERTX_TWO_OP__(low,< ,exp,< ,high,"%zu",fmt,##__VA_ARGS__) // Assert low < exp < high (size_t)
...
#define ASX_BETWEEN_EI_SSIZET(low, exp, high, fmt, ...) __ASSERTX_TWO_OP__(low,< ,exp,<=,high,"%zd",fmt,##__VA_ARGS__) // Assert low < exp <= high (ssize_t)
#define ASX_BETWEEN_EE_SSIZET(low, exp, high, fmt, ...) __ASSERTX_TWO_OP__(low,< ,exp,< ,high,"%zd",fmt,##__VA_ARGS__) // Assert low < exp < high (ssize_t)
...
#define ASX_BETWEEN_EI_F32(low, exp, high, fmt, ...) __ASSERTX_TWO_OP__(low,< ,exp,<=,high,"%f",fmt,##__VA_ARGS__) // Assert low < exp <= high (float)
#define ASX_BETWEEN_EE_F32(low, exp, high, fmt, ...) __ASSERTX_TWO_OP__(low,< ,exp,< ,high,"%f",fmt,##__VA_ARGS__) // Assert low < exp < high (float)
...
#define ASX_BETWEEN_EI_F64(low, exp, high, fmt, ...) __ASSERTX_TWO_OP__(low,< ,exp,<=,high,"%f",fmt,##__VA_ARGS__) // Assert low < exp <= high (double)
#define ASX_BETWEEN_EE_F64(low, exp, high, fmt, ...) __ASSERTX_TWO_OP__(low,< ,exp,< ,high,"%f",fmt,##__VA_ARGS__) // Assert low < exp < high (double)
/*
...
ops = [("EQ", 1, "=="),("NE", 1, "!="),("LT", 1, "<"),("LE", 1, "<="),("GT", 1, ">"),("GE", 1, ">="),("BETWEEN_IE", 2, "<=", "<"),("BETWEEN_II", 2, "<=", "<="),("BETWEEN_EI", 2, "<", "<="),("BETWEEN_EE", 2, "<", "<")]

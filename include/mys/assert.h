...
#define _ASX(exp, fmt, ...) if (!(exp)) {             \
    ...
    mys_log_rank(MYS_LOGGER_G, _rank_, MYS_LOG_FATAL, \
        __FILE__, __LINE__,                           \
        (fmt), ##__VA_ARGS__);                        \
    /*mys_MPI_Finalize();*/                           \
    /*exit(0);*/                                      \
...
#define AS_EQ_I8(exp1, exp2)             _ASX_2(int8_t,exp1,==,exp2,"%" PRIi8,"") // Assert exp1 == exp2 (int8_t)
#define AS_NE_I8(exp1, exp2)             _ASX_2(int8_t,exp1,!=,exp2,"%" PRIi8,"") // Assert exp1 != exp2 (int8_t)
#define AS_LT_I8(exp1, exp2)             _ASX_2(int8_t,exp1,< ,exp2,"%" PRIi8,"") // Assert exp1 < exp2 (int8_t)
#define AS_LE_I8(exp1, exp2)             _ASX_2(int8_t,exp1,<=,exp2,"%" PRIi8,"") // Assert exp1 <= exp2 (int8_t)
#define AS_GT_I8(exp1, exp2)             _ASX_2(int8_t,exp1,> ,exp2,"%" PRIi8,"") // Assert exp1 > exp2 (int8_t)
#define AS_GE_I8(exp1, exp2)             _ASX_2(int8_t,exp1,>=,exp2,"%" PRIi8,"") // Assert exp1 >= exp2 (int8_t)
#define AS_BETWEEN_IE_I8(low, exp, high) _ASX_3(int8_t,low,<=,exp,< ,high,"%" PRIi8,"") // Assert low <= exp < high (int8_t)
#define AS_BETWEEN_II_I8(low, exp, high) _ASX_3(int8_t,low,<=,exp,<=,high,"%" PRIi8,"") // Assert low <= exp <= high (int8_t)
#define AS_BETWEEN_EI_I8(low, exp, high) _ASX_3(int8_t,low,< ,exp,<=,high,"%" PRIi8,"") // Assert low < exp <= high (int8_t)
#define AS_BETWEEN_EE_I8(low, exp, high) _ASX_3(int8_t,low,< ,exp,< ,high,"%" PRIi8,"") // Assert low < exp < high (int8_t)
#define AS_EQ_I16(exp1, exp2)             _ASX_2(int16_t,exp1,==,exp2,"%" PRIi16,"") // Assert exp1 == exp2 (int16_t)
#define AS_NE_I16(exp1, exp2)             _ASX_2(int16_t,exp1,!=,exp2,"%" PRIi16,"") // Assert exp1 != exp2 (int16_t)
#define AS_LT_I16(exp1, exp2)             _ASX_2(int16_t,exp1,< ,exp2,"%" PRIi16,"") // Assert exp1 < exp2 (int16_t)
#define AS_LE_I16(exp1, exp2)             _ASX_2(int16_t,exp1,<=,exp2,"%" PRIi16,"") // Assert exp1 <= exp2 (int16_t)
#define AS_GT_I16(exp1, exp2)             _ASX_2(int16_t,exp1,> ,exp2,"%" PRIi16,"") // Assert exp1 > exp2 (int16_t)
#define AS_GE_I16(exp1, exp2)             _ASX_2(int16_t,exp1,>=,exp2,"%" PRIi16,"") // Assert exp1 >= exp2 (int16_t)
#define AS_BETWEEN_IE_I16(low, exp, high) _ASX_3(int16_t,low,<=,exp,< ,high,"%" PRIi16,"") // Assert low <= exp < high (int16_t)
#define AS_BETWEEN_II_I16(low, exp, high) _ASX_3(int16_t,low,<=,exp,<=,high,"%" PRIi16,"") // Assert low <= exp <= high (int16_t)
#define AS_BETWEEN_EI_I16(low, exp, high) _ASX_3(int16_t,low,< ,exp,<=,high,"%" PRIi16,"") // Assert low < exp <= high (int16_t)
#define AS_BETWEEN_EE_I16(low, exp, high) _ASX_3(int16_t,low,< ,exp,< ,high,"%" PRIi16,"") // Assert low < exp < high (int16_t)
#define AS_EQ_I32(exp1, exp2)             _ASX_2(int32_t,exp1,==,exp2,"%" PRIi32,"") // Assert exp1 == exp2 (int32_t)
#define AS_NE_I32(exp1, exp2)             _ASX_2(int32_t,exp1,!=,exp2,"%" PRIi32,"") // Assert exp1 != exp2 (int32_t)
#define AS_LT_I32(exp1, exp2)             _ASX_2(int32_t,exp1,< ,exp2,"%" PRIi32,"") // Assert exp1 < exp2 (int32_t)
#define AS_LE_I32(exp1, exp2)             _ASX_2(int32_t,exp1,<=,exp2,"%" PRIi32,"") // Assert exp1 <= exp2 (int32_t)
#define AS_GT_I32(exp1, exp2)             _ASX_2(int32_t,exp1,> ,exp2,"%" PRIi32,"") // Assert exp1 > exp2 (int32_t)
#define AS_GE_I32(exp1, exp2)             _ASX_2(int32_t,exp1,>=,exp2,"%" PRIi32,"") // Assert exp1 >= exp2 (int32_t)
#define AS_BETWEEN_IE_I32(low, exp, high) _ASX_3(int32_t,low,<=,exp,< ,high,"%" PRIi32,"") // Assert low <= exp < high (int32_t)
#define AS_BETWEEN_II_I32(low, exp, high) _ASX_3(int32_t,low,<=,exp,<=,high,"%" PRIi32,"") // Assert low <= exp <= high (int32_t)
#define AS_BETWEEN_EI_I32(low, exp, high) _ASX_3(int32_t,low,< ,exp,<=,high,"%" PRIi32,"") // Assert low < exp <= high (int32_t)
#define AS_BETWEEN_EE_I32(low, exp, high) _ASX_3(int32_t,low,< ,exp,< ,high,"%" PRIi32,"") // Assert low < exp < high (int32_t)
#define AS_EQ_I64(exp1, exp2)             _ASX_2(int64_t,exp1,==,exp2,"%" PRIi64,"") // Assert exp1 == exp2 (int64_t)
#define AS_NE_I64(exp1, exp2)             _ASX_2(int64_t,exp1,!=,exp2,"%" PRIi64,"") // Assert exp1 != exp2 (int64_t)
#define AS_LT_I64(exp1, exp2)             _ASX_2(int64_t,exp1,< ,exp2,"%" PRIi64,"") // Assert exp1 < exp2 (int64_t)
#define AS_LE_I64(exp1, exp2)             _ASX_2(int64_t,exp1,<=,exp2,"%" PRIi64,"") // Assert exp1 <= exp2 (int64_t)
#define AS_GT_I64(exp1, exp2)             _ASX_2(int64_t,exp1,> ,exp2,"%" PRIi64,"") // Assert exp1 > exp2 (int64_t)
#define AS_GE_I64(exp1, exp2)             _ASX_2(int64_t,exp1,>=,exp2,"%" PRIi64,"") // Assert exp1 >= exp2 (int64_t)
#define AS_BETWEEN_IE_I64(low, exp, high) _ASX_3(int64_t,low,<=,exp,< ,high,"%" PRIi64,"") // Assert low <= exp < high (int64_t)
#define AS_BETWEEN_II_I64(low, exp, high) _ASX_3(int64_t,low,<=,exp,<=,high,"%" PRIi64,"") // Assert low <= exp <= high (int64_t)
#define AS_BETWEEN_EI_I64(low, exp, high) _ASX_3(int64_t,low,< ,exp,<=,high,"%" PRIi64,"") // Assert low < exp <= high (int64_t)
#define AS_BETWEEN_EE_I64(low, exp, high) _ASX_3(int64_t,low,< ,exp,< ,high,"%" PRIi64,"") // Assert low < exp < high (int64_t)
#define AS_EQ_U8(exp1, exp2)             _ASX_2(uint8_t,exp1,==,exp2,"%" PRIu8,"") // Assert exp1 == exp2 (uint8_t)
#define AS_NE_U8(exp1, exp2)             _ASX_2(uint8_t,exp1,!=,exp2,"%" PRIu8,"") // Assert exp1 != exp2 (uint8_t)
#define AS_LT_U8(exp1, exp2)             _ASX_2(uint8_t,exp1,< ,exp2,"%" PRIu8,"") // Assert exp1 < exp2 (uint8_t)
#define AS_LE_U8(exp1, exp2)             _ASX_2(uint8_t,exp1,<=,exp2,"%" PRIu8,"") // Assert exp1 <= exp2 (uint8_t)
#define AS_GT_U8(exp1, exp2)             _ASX_2(uint8_t,exp1,> ,exp2,"%" PRIu8,"") // Assert exp1 > exp2 (uint8_t)
#define AS_GE_U8(exp1, exp2)             _ASX_2(uint8_t,exp1,>=,exp2,"%" PRIu8,"") // Assert exp1 >= exp2 (uint8_t)
#define AS_BETWEEN_IE_U8(low, exp, high) _ASX_3(uint8_t,low,<=,exp,< ,high,"%" PRIu8,"") // Assert low <= exp < high (uint8_t)
#define AS_BETWEEN_II_U8(low, exp, high) _ASX_3(uint8_t,low,<=,exp,<=,high,"%" PRIu8,"") // Assert low <= exp <= high (uint8_t)
#define AS_BETWEEN_EI_U8(low, exp, high) _ASX_3(uint8_t,low,< ,exp,<=,high,"%" PRIu8,"") // Assert low < exp <= high (uint8_t)
#define AS_BETWEEN_EE_U8(low, exp, high) _ASX_3(uint8_t,low,< ,exp,< ,high,"%" PRIu8,"") // Assert low < exp < high (uint8_t)
#define AS_EQ_U16(exp1, exp2)             _ASX_2(uint16_t,exp1,==,exp2,"%" PRIu16,"") // Assert exp1 == exp2 (uint16_t)
#define AS_NE_U16(exp1, exp2)             _ASX_2(uint16_t,exp1,!=,exp2,"%" PRIu16,"") // Assert exp1 != exp2 (uint16_t)
#define AS_LT_U16(exp1, exp2)             _ASX_2(uint16_t,exp1,< ,exp2,"%" PRIu16,"") // Assert exp1 < exp2 (uint16_t)
#define AS_LE_U16(exp1, exp2)             _ASX_2(uint16_t,exp1,<=,exp2,"%" PRIu16,"") // Assert exp1 <= exp2 (uint16_t)
#define AS_GT_U16(exp1, exp2)             _ASX_2(uint16_t,exp1,> ,exp2,"%" PRIu16,"") // Assert exp1 > exp2 (uint16_t)
#define AS_GE_U16(exp1, exp2)             _ASX_2(uint16_t,exp1,>=,exp2,"%" PRIu16,"") // Assert exp1 >= exp2 (uint16_t)
#define AS_BETWEEN_IE_U16(low, exp, high) _ASX_3(uint16_t,low,<=,exp,< ,high,"%" PRIu16,"") // Assert low <= exp < high (uint16_t)
#define AS_BETWEEN_II_U16(low, exp, high) _ASX_3(uint16_t,low,<=,exp,<=,high,"%" PRIu16,"") // Assert low <= exp <= high (uint16_t)
#define AS_BETWEEN_EI_U16(low, exp, high) _ASX_3(uint16_t,low,< ,exp,<=,high,"%" PRIu16,"") // Assert low < exp <= high (uint16_t)
#define AS_BETWEEN_EE_U16(low, exp, high) _ASX_3(uint16_t,low,< ,exp,< ,high,"%" PRIu16,"") // Assert low < exp < high (uint16_t)
#define AS_EQ_U32(exp1, exp2)             _ASX_2(uint32_t,exp1,==,exp2,"%" PRIu32,"") // Assert exp1 == exp2 (uint32_t)
#define AS_NE_U32(exp1, exp2)             _ASX_2(uint32_t,exp1,!=,exp2,"%" PRIu32,"") // Assert exp1 != exp2 (uint32_t)
#define AS_LT_U32(exp1, exp2)             _ASX_2(uint32_t,exp1,< ,exp2,"%" PRIu32,"") // Assert exp1 < exp2 (uint32_t)
#define AS_LE_U32(exp1, exp2)             _ASX_2(uint32_t,exp1,<=,exp2,"%" PRIu32,"") // Assert exp1 <= exp2 (uint32_t)
#define AS_GT_U32(exp1, exp2)             _ASX_2(uint32_t,exp1,> ,exp2,"%" PRIu32,"") // Assert exp1 > exp2 (uint32_t)
#define AS_GE_U32(exp1, exp2)             _ASX_2(uint32_t,exp1,>=,exp2,"%" PRIu32,"") // Assert exp1 >= exp2 (uint32_t)
#define AS_BETWEEN_IE_U32(low, exp, high) _ASX_3(uint32_t,low,<=,exp,< ,high,"%" PRIu32,"") // Assert low <= exp < high (uint32_t)
#define AS_BETWEEN_II_U32(low, exp, high) _ASX_3(uint32_t,low,<=,exp,<=,high,"%" PRIu32,"") // Assert low <= exp <= high (uint32_t)
#define AS_BETWEEN_EI_U32(low, exp, high) _ASX_3(uint32_t,low,< ,exp,<=,high,"%" PRIu32,"") // Assert low < exp <= high (uint32_t)
#define AS_BETWEEN_EE_U32(low, exp, high) _ASX_3(uint32_t,low,< ,exp,< ,high,"%" PRIu32,"") // Assert low < exp < high (uint32_t)
#define AS_EQ_U64(exp1, exp2)             _ASX_2(uint64_t,exp1,==,exp2,"%" PRIu64,"") // Assert exp1 == exp2 (uint64_t)
#define AS_NE_U64(exp1, exp2)             _ASX_2(uint64_t,exp1,!=,exp2,"%" PRIu64,"") // Assert exp1 != exp2 (uint64_t)
#define AS_LT_U64(exp1, exp2)             _ASX_2(uint64_t,exp1,< ,exp2,"%" PRIu64,"") // Assert exp1 < exp2 (uint64_t)
#define AS_LE_U64(exp1, exp2)             _ASX_2(uint64_t,exp1,<=,exp2,"%" PRIu64,"") // Assert exp1 <= exp2 (uint64_t)
#define AS_GT_U64(exp1, exp2)             _ASX_2(uint64_t,exp1,> ,exp2,"%" PRIu64,"") // Assert exp1 > exp2 (uint64_t)
#define AS_GE_U64(exp1, exp2)             _ASX_2(uint64_t,exp1,>=,exp2,"%" PRIu64,"") // Assert exp1 >= exp2 (uint64_t)
#define AS_BETWEEN_IE_U64(low, exp, high) _ASX_3(uint64_t,low,<=,exp,< ,high,"%" PRIu64,"") // Assert low <= exp < high (uint64_t)
#define AS_BETWEEN_II_U64(low, exp, high) _ASX_3(uint64_t,low,<=,exp,<=,high,"%" PRIu64,"") // Assert low <= exp <= high (uint64_t)
#define AS_BETWEEN_EI_U64(low, exp, high) _ASX_3(uint64_t,low,< ,exp,<=,high,"%" PRIu64,"") // Assert low < exp <= high (uint64_t)
#define AS_BETWEEN_EE_U64(low, exp, high) _ASX_3(uint64_t,low,< ,exp,< ,high,"%" PRIu64,"") // Assert low < exp < high (uint64_t)
...
#define ASX_EQ_I8(exp1, exp2, fmt, ...)             _ASX_2(int8_t,exp1,==,exp2,"%" PRIi8,fmt,##__VA_ARGS__) // Assert exp1 == exp2 (int8_t)
#define ASX_NE_I8(exp1, exp2, fmt, ...)             _ASX_2(int8_t,exp1,!=,exp2,"%" PRIi8,fmt,##__VA_ARGS__) // Assert exp1 != exp2 (int8_t)
#define ASX_LT_I8(exp1, exp2, fmt, ...)             _ASX_2(int8_t,exp1,< ,exp2,"%" PRIi8,fmt,##__VA_ARGS__) // Assert exp1 < exp2 (int8_t)
#define ASX_LE_I8(exp1, exp2, fmt, ...)             _ASX_2(int8_t,exp1,<=,exp2,"%" PRIi8,fmt,##__VA_ARGS__) // Assert exp1 <= exp2 (int8_t)
#define ASX_GT_I8(exp1, exp2, fmt, ...)             _ASX_2(int8_t,exp1,> ,exp2,"%" PRIi8,fmt,##__VA_ARGS__) // Assert exp1 > exp2 (int8_t)
#define ASX_GE_I8(exp1, exp2, fmt, ...)             _ASX_2(int8_t,exp1,>=,exp2,"%" PRIi8,fmt,##__VA_ARGS__) // Assert exp1 >= exp2 (int8_t)
#define ASX_BETWEEN_IE_I8(low, exp, high, fmt, ...) _ASX_3(int8_t,low,<=,exp,< ,high,"%" PRIi8,fmt,##__VA_ARGS__) // Assert low <= exp < high (int8_t)
#define ASX_BETWEEN_II_I8(low, exp, high, fmt, ...) _ASX_3(int8_t,low,<=,exp,<=,high,"%" PRIi8,fmt,##__VA_ARGS__) // Assert low <= exp <= high (int8_t)
#define ASX_BETWEEN_EI_I8(low, exp, high, fmt, ...) _ASX_3(int8_t,low,< ,exp,<=,high,"%" PRIi8,fmt,##__VA_ARGS__) // Assert low < exp <= high (int8_t)
#define ASX_BETWEEN_EE_I8(low, exp, high, fmt, ...) _ASX_3(int8_t,low,< ,exp,< ,high,"%" PRIi8,fmt,##__VA_ARGS__) // Assert low < exp < high (int8_t)
#define ASX_EQ_I16(exp1, exp2, fmt, ...)             _ASX_2(int16_t,exp1,==,exp2,"%" PRIi16,fmt,##__VA_ARGS__) // Assert exp1 == exp2 (int16_t)
#define ASX_NE_I16(exp1, exp2, fmt, ...)             _ASX_2(int16_t,exp1,!=,exp2,"%" PRIi16,fmt,##__VA_ARGS__) // Assert exp1 != exp2 (int16_t)
#define ASX_LT_I16(exp1, exp2, fmt, ...)             _ASX_2(int16_t,exp1,< ,exp2,"%" PRIi16,fmt,##__VA_ARGS__) // Assert exp1 < exp2 (int16_t)
#define ASX_LE_I16(exp1, exp2, fmt, ...)             _ASX_2(int16_t,exp1,<=,exp2,"%" PRIi16,fmt,##__VA_ARGS__) // Assert exp1 <= exp2 (int16_t)
#define ASX_GT_I16(exp1, exp2, fmt, ...)             _ASX_2(int16_t,exp1,> ,exp2,"%" PRIi16,fmt,##__VA_ARGS__) // Assert exp1 > exp2 (int16_t)
#define ASX_GE_I16(exp1, exp2, fmt, ...)             _ASX_2(int16_t,exp1,>=,exp2,"%" PRIi16,fmt,##__VA_ARGS__) // Assert exp1 >= exp2 (int16_t)
#define ASX_BETWEEN_IE_I16(low, exp, high, fmt, ...) _ASX_3(int16_t,low,<=,exp,< ,high,"%" PRIi16,fmt,##__VA_ARGS__) // Assert low <= exp < high (int16_t)
#define ASX_BETWEEN_II_I16(low, exp, high, fmt, ...) _ASX_3(int16_t,low,<=,exp,<=,high,"%" PRIi16,fmt,##__VA_ARGS__) // Assert low <= exp <= high (int16_t)
#define ASX_BETWEEN_EI_I16(low, exp, high, fmt, ...) _ASX_3(int16_t,low,< ,exp,<=,high,"%" PRIi16,fmt,##__VA_ARGS__) // Assert low < exp <= high (int16_t)
#define ASX_BETWEEN_EE_I16(low, exp, high, fmt, ...) _ASX_3(int16_t,low,< ,exp,< ,high,"%" PRIi16,fmt,##__VA_ARGS__) // Assert low < exp < high (int16_t)
#define ASX_EQ_I32(exp1, exp2, fmt, ...)             _ASX_2(int32_t,exp1,==,exp2,"%" PRIi32,fmt,##__VA_ARGS__) // Assert exp1 == exp2 (int32_t)
#define ASX_NE_I32(exp1, exp2, fmt, ...)             _ASX_2(int32_t,exp1,!=,exp2,"%" PRIi32,fmt,##__VA_ARGS__) // Assert exp1 != exp2 (int32_t)
#define ASX_LT_I32(exp1, exp2, fmt, ...)             _ASX_2(int32_t,exp1,< ,exp2,"%" PRIi32,fmt,##__VA_ARGS__) // Assert exp1 < exp2 (int32_t)
#define ASX_LE_I32(exp1, exp2, fmt, ...)             _ASX_2(int32_t,exp1,<=,exp2,"%" PRIi32,fmt,##__VA_ARGS__) // Assert exp1 <= exp2 (int32_t)
#define ASX_GT_I32(exp1, exp2, fmt, ...)             _ASX_2(int32_t,exp1,> ,exp2,"%" PRIi32,fmt,##__VA_ARGS__) // Assert exp1 > exp2 (int32_t)
#define ASX_GE_I32(exp1, exp2, fmt, ...)             _ASX_2(int32_t,exp1,>=,exp2,"%" PRIi32,fmt,##__VA_ARGS__) // Assert exp1 >= exp2 (int32_t)
#define ASX_BETWEEN_IE_I32(low, exp, high, fmt, ...) _ASX_3(int32_t,low,<=,exp,< ,high,"%" PRIi32,fmt,##__VA_ARGS__) // Assert low <= exp < high (int32_t)
#define ASX_BETWEEN_II_I32(low, exp, high, fmt, ...) _ASX_3(int32_t,low,<=,exp,<=,high,"%" PRIi32,fmt,##__VA_ARGS__) // Assert low <= exp <= high (int32_t)
#define ASX_BETWEEN_EI_I32(low, exp, high, fmt, ...) _ASX_3(int32_t,low,< ,exp,<=,high,"%" PRIi32,fmt,##__VA_ARGS__) // Assert low < exp <= high (int32_t)
#define ASX_BETWEEN_EE_I32(low, exp, high, fmt, ...) _ASX_3(int32_t,low,< ,exp,< ,high,"%" PRIi32,fmt,##__VA_ARGS__) // Assert low < exp < high (int32_t)
#define ASX_EQ_I64(exp1, exp2, fmt, ...)             _ASX_2(int64_t,exp1,==,exp2,"%" PRIi64,fmt,##__VA_ARGS__) // Assert exp1 == exp2 (int64_t)
#define ASX_NE_I64(exp1, exp2, fmt, ...)             _ASX_2(int64_t,exp1,!=,exp2,"%" PRIi64,fmt,##__VA_ARGS__) // Assert exp1 != exp2 (int64_t)
#define ASX_LT_I64(exp1, exp2, fmt, ...)             _ASX_2(int64_t,exp1,< ,exp2,"%" PRIi64,fmt,##__VA_ARGS__) // Assert exp1 < exp2 (int64_t)
#define ASX_LE_I64(exp1, exp2, fmt, ...)             _ASX_2(int64_t,exp1,<=,exp2,"%" PRIi64,fmt,##__VA_ARGS__) // Assert exp1 <= exp2 (int64_t)
#define ASX_GT_I64(exp1, exp2, fmt, ...)             _ASX_2(int64_t,exp1,> ,exp2,"%" PRIi64,fmt,##__VA_ARGS__) // Assert exp1 > exp2 (int64_t)
#define ASX_GE_I64(exp1, exp2, fmt, ...)             _ASX_2(int64_t,exp1,>=,exp2,"%" PRIi64,fmt,##__VA_ARGS__) // Assert exp1 >= exp2 (int64_t)
#define ASX_BETWEEN_IE_I64(low, exp, high, fmt, ...) _ASX_3(int64_t,low,<=,exp,< ,high,"%" PRIi64,fmt,##__VA_ARGS__) // Assert low <= exp < high (int64_t)
#define ASX_BETWEEN_II_I64(low, exp, high, fmt, ...) _ASX_3(int64_t,low,<=,exp,<=,high,"%" PRIi64,fmt,##__VA_ARGS__) // Assert low <= exp <= high (int64_t)
#define ASX_BETWEEN_EI_I64(low, exp, high, fmt, ...) _ASX_3(int64_t,low,< ,exp,<=,high,"%" PRIi64,fmt,##__VA_ARGS__) // Assert low < exp <= high (int64_t)
#define ASX_BETWEEN_EE_I64(low, exp, high, fmt, ...) _ASX_3(int64_t,low,< ,exp,< ,high,"%" PRIi64,fmt,##__VA_ARGS__) // Assert low < exp < high (int64_t)
#define ASX_EQ_U8(exp1, exp2, fmt, ...)             _ASX_2(uint8_t,exp1,==,exp2,"%" PRIu8,fmt,##__VA_ARGS__) // Assert exp1 == exp2 (uint8_t)
#define ASX_NE_U8(exp1, exp2, fmt, ...)             _ASX_2(uint8_t,exp1,!=,exp2,"%" PRIu8,fmt,##__VA_ARGS__) // Assert exp1 != exp2 (uint8_t)
#define ASX_LT_U8(exp1, exp2, fmt, ...)             _ASX_2(uint8_t,exp1,< ,exp2,"%" PRIu8,fmt,##__VA_ARGS__) // Assert exp1 < exp2 (uint8_t)
#define ASX_LE_U8(exp1, exp2, fmt, ...)             _ASX_2(uint8_t,exp1,<=,exp2,"%" PRIu8,fmt,##__VA_ARGS__) // Assert exp1 <= exp2 (uint8_t)
#define ASX_GT_U8(exp1, exp2, fmt, ...)             _ASX_2(uint8_t,exp1,> ,exp2,"%" PRIu8,fmt,##__VA_ARGS__) // Assert exp1 > exp2 (uint8_t)
#define ASX_GE_U8(exp1, exp2, fmt, ...)             _ASX_2(uint8_t,exp1,>=,exp2,"%" PRIu8,fmt,##__VA_ARGS__) // Assert exp1 >= exp2 (uint8_t)
#define ASX_BETWEEN_IE_U8(low, exp, high, fmt, ...) _ASX_3(uint8_t,low,<=,exp,< ,high,"%" PRIu8,fmt,##__VA_ARGS__) // Assert low <= exp < high (uint8_t)
#define ASX_BETWEEN_II_U8(low, exp, high, fmt, ...) _ASX_3(uint8_t,low,<=,exp,<=,high,"%" PRIu8,fmt,##__VA_ARGS__) // Assert low <= exp <= high (uint8_t)
#define ASX_BETWEEN_EI_U8(low, exp, high, fmt, ...) _ASX_3(uint8_t,low,< ,exp,<=,high,"%" PRIu8,fmt,##__VA_ARGS__) // Assert low < exp <= high (uint8_t)
#define ASX_BETWEEN_EE_U8(low, exp, high, fmt, ...) _ASX_3(uint8_t,low,< ,exp,< ,high,"%" PRIu8,fmt,##__VA_ARGS__) // Assert low < exp < high (uint8_t)
#define ASX_EQ_U16(exp1, exp2, fmt, ...)             _ASX_2(uint16_t,exp1,==,exp2,"%" PRIu16,fmt,##__VA_ARGS__) // Assert exp1 == exp2 (uint16_t)
#define ASX_NE_U16(exp1, exp2, fmt, ...)             _ASX_2(uint16_t,exp1,!=,exp2,"%" PRIu16,fmt,##__VA_ARGS__) // Assert exp1 != exp2 (uint16_t)
#define ASX_LT_U16(exp1, exp2, fmt, ...)             _ASX_2(uint16_t,exp1,< ,exp2,"%" PRIu16,fmt,##__VA_ARGS__) // Assert exp1 < exp2 (uint16_t)
#define ASX_LE_U16(exp1, exp2, fmt, ...)             _ASX_2(uint16_t,exp1,<=,exp2,"%" PRIu16,fmt,##__VA_ARGS__) // Assert exp1 <= exp2 (uint16_t)
#define ASX_GT_U16(exp1, exp2, fmt, ...)             _ASX_2(uint16_t,exp1,> ,exp2,"%" PRIu16,fmt,##__VA_ARGS__) // Assert exp1 > exp2 (uint16_t)
#define ASX_GE_U16(exp1, exp2, fmt, ...)             _ASX_2(uint16_t,exp1,>=,exp2,"%" PRIu16,fmt,##__VA_ARGS__) // Assert exp1 >= exp2 (uint16_t)
#define ASX_BETWEEN_IE_U16(low, exp, high, fmt, ...) _ASX_3(uint16_t,low,<=,exp,< ,high,"%" PRIu16,fmt,##__VA_ARGS__) // Assert low <= exp < high (uint16_t)
#define ASX_BETWEEN_II_U16(low, exp, high, fmt, ...) _ASX_3(uint16_t,low,<=,exp,<=,high,"%" PRIu16,fmt,##__VA_ARGS__) // Assert low <= exp <= high (uint16_t)
#define ASX_BETWEEN_EI_U16(low, exp, high, fmt, ...) _ASX_3(uint16_t,low,< ,exp,<=,high,"%" PRIu16,fmt,##__VA_ARGS__) // Assert low < exp <= high (uint16_t)
#define ASX_BETWEEN_EE_U16(low, exp, high, fmt, ...) _ASX_3(uint16_t,low,< ,exp,< ,high,"%" PRIu16,fmt,##__VA_ARGS__) // Assert low < exp < high (uint16_t)
#define ASX_EQ_U32(exp1, exp2, fmt, ...)             _ASX_2(uint32_t,exp1,==,exp2,"%" PRIu32,fmt,##__VA_ARGS__) // Assert exp1 == exp2 (uint32_t)
#define ASX_NE_U32(exp1, exp2, fmt, ...)             _ASX_2(uint32_t,exp1,!=,exp2,"%" PRIu32,fmt,##__VA_ARGS__) // Assert exp1 != exp2 (uint32_t)
#define ASX_LT_U32(exp1, exp2, fmt, ...)             _ASX_2(uint32_t,exp1,< ,exp2,"%" PRIu32,fmt,##__VA_ARGS__) // Assert exp1 < exp2 (uint32_t)
#define ASX_LE_U32(exp1, exp2, fmt, ...)             _ASX_2(uint32_t,exp1,<=,exp2,"%" PRIu32,fmt,##__VA_ARGS__) // Assert exp1 <= exp2 (uint32_t)
#define ASX_GT_U32(exp1, exp2, fmt, ...)             _ASX_2(uint32_t,exp1,> ,exp2,"%" PRIu32,fmt,##__VA_ARGS__) // Assert exp1 > exp2 (uint32_t)
#define ASX_GE_U32(exp1, exp2, fmt, ...)             _ASX_2(uint32_t,exp1,>=,exp2,"%" PRIu32,fmt,##__VA_ARGS__) // Assert exp1 >= exp2 (uint32_t)
#define ASX_BETWEEN_IE_U32(low, exp, high, fmt, ...) _ASX_3(uint32_t,low,<=,exp,< ,high,"%" PRIu32,fmt,##__VA_ARGS__) // Assert low <= exp < high (uint32_t)
#define ASX_BETWEEN_II_U32(low, exp, high, fmt, ...) _ASX_3(uint32_t,low,<=,exp,<=,high,"%" PRIu32,fmt,##__VA_ARGS__) // Assert low <= exp <= high (uint32_t)
#define ASX_BETWEEN_EI_U32(low, exp, high, fmt, ...) _ASX_3(uint32_t,low,< ,exp,<=,high,"%" PRIu32,fmt,##__VA_ARGS__) // Assert low < exp <= high (uint32_t)
#define ASX_BETWEEN_EE_U32(low, exp, high, fmt, ...) _ASX_3(uint32_t,low,< ,exp,< ,high,"%" PRIu32,fmt,##__VA_ARGS__) // Assert low < exp < high (uint32_t)
#define ASX_EQ_U64(exp1, exp2, fmt, ...)             _ASX_2(uint64_t,exp1,==,exp2,"%" PRIu64,fmt,##__VA_ARGS__) // Assert exp1 == exp2 (uint64_t)
#define ASX_NE_U64(exp1, exp2, fmt, ...)             _ASX_2(uint64_t,exp1,!=,exp2,"%" PRIu64,fmt,##__VA_ARGS__) // Assert exp1 != exp2 (uint64_t)
#define ASX_LT_U64(exp1, exp2, fmt, ...)             _ASX_2(uint64_t,exp1,< ,exp2,"%" PRIu64,fmt,##__VA_ARGS__) // Assert exp1 < exp2 (uint64_t)
#define ASX_LE_U64(exp1, exp2, fmt, ...)             _ASX_2(uint64_t,exp1,<=,exp2,"%" PRIu64,fmt,##__VA_ARGS__) // Assert exp1 <= exp2 (uint64_t)
#define ASX_GT_U64(exp1, exp2, fmt, ...)             _ASX_2(uint64_t,exp1,> ,exp2,"%" PRIu64,fmt,##__VA_ARGS__) // Assert exp1 > exp2 (uint64_t)
#define ASX_GE_U64(exp1, exp2, fmt, ...)             _ASX_2(uint64_t,exp1,>=,exp2,"%" PRIu64,fmt,##__VA_ARGS__) // Assert exp1 >= exp2 (uint64_t)
#define ASX_BETWEEN_IE_U64(low, exp, high, fmt, ...) _ASX_3(uint64_t,low,<=,exp,< ,high,"%" PRIu64,fmt,##__VA_ARGS__) // Assert low <= exp < high (uint64_t)
#define ASX_BETWEEN_II_U64(low, exp, high, fmt, ...) _ASX_3(uint64_t,low,<=,exp,<=,high,"%" PRIu64,fmt,##__VA_ARGS__) // Assert low <= exp <= high (uint64_t)
#define ASX_BETWEEN_EI_U64(low, exp, high, fmt, ...) _ASX_3(uint64_t,low,< ,exp,<=,high,"%" PRIu64,fmt,##__VA_ARGS__) // Assert low < exp <= high (uint64_t)
#define ASX_BETWEEN_EE_U64(low, exp, high, fmt, ...) _ASX_3(uint64_t,low,< ,exp,< ,high,"%" PRIu64,fmt,##__VA_ARGS__) // Assert low < exp < high (uint64_t)
    ...
    for typ in types:
        ...
        for op in ops:
            ...
            if category[1] == False:
                ...
                prefix += f", fmt, ...)"
            suffix = ""
            fmt_spec = f'"%" {typ[2]}' if typ[2].startswith("PRI") else f'"{typ[2]}"'
            if op[1] == 2:
                suffix += f'_ASX_2({typ[0]},exp1,{op[2]:2s},exp2,{fmt_spec},'
            elif op[1] == 3:
                suffix += f'_ASX_3({typ[0]},low,{op[2]:2s},exp,{op[3]:2s},high,{fmt_spec},'
            if category[1] == False:
                suffix += f'"")'
            else:

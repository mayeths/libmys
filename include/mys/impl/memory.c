...
MYS_STATIC mys_arena_t _mys_arena_commgroup = { /*name=*/"mys_commgroup", /*peak=*/0, /*alive=*/0, /*freed=*/0, /*total=*/0, /*_reged=*/false };
...
mys_arena_t* mys_arena_commgroup = &_mys_arena_commgroup;
